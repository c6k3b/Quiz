...
final class IOSUIKitViewControllerFactoryTest: XCTestCase {
	...
	func test_questionViewController_multipleAnswer_createsControllerWithTitle() {
		let controller = makeQuestionsController(question: multipleAnswerQuestion)
	...
	private func makeQuestionsController(question: Question<String>, answerCallback: @escaping ([String]) -> Void = { _ in }) -> QuestionViewController {
		let sut = makeSUT()
